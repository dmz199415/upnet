...
from nets_unet import Unet
from nets_unet_training import CE_Loss, Dice_loss, LossHistory
from utils_dataloader import DeeplabDataset, deeplab_dataset_collate
...
if __name__ == "__main__":
    ...
    #   权值和主干特征提取网络一定要对应
    # -------------------------------------------#
    # model_path = r"model_data/particles.pth"
